...
// The go1.24.5-embedded command compiles and runs the go command from Embedded Go
// 1.24.5
//
// To install, run:
//
...
//
// in your environment or use the go1.24.5-embedded command directly.
package main

import "github.com/embeddedgo/dl/internal/version"

func main() {
	version.RunTag("go1.24.5-embedded")
}